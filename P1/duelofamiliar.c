...
int main()
{
    ...
    for(int rodada = 1; rodada <= numrodadas; rodada++)
    {
        ...
        if(somaluke == 3)
        {
            if(somaluketransversal1 == 3)vaderlife -= 15;
            if(somaluketransversal2 == 3) vaderlife -= 15;
        }
        if(somavader == 3)
        {
            if(somavadertransversal1 == 3) lukelife -= 15;
            if(somavadertransversal2 == 3) lukelife -= 15;
        }
        if(lukelife == 0)
        {
            if(vaderlife==0)
